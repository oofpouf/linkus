                      ...
                      Form(
                        child: Column(
                          children: [
                            ...
                            // Year of study title
                            userProf
                                .generateEditTitle('Year of Study (e.g. 1, 2)'),
                            const SizedBox(height: 10.0),

                            // Year of study textfield
                            userProf.generateNumField(
                                'year of study', _yearController),
                            const SizedBox(height: 30),

                            // Degree title
                            userProf.generateEditTitle(
                                'Degree (e.g. Computer Science)'),
                            const SizedBox(height: 10.0),

                            // Degree textfield
                            userProf.generateTextField(
                                'degree', _degreeController),
                            const SizedBox(height: 30),
                            ...
                            // Course 1
                            userProf.generateTextField(
                                'course code', _course1Controller),
                            const SizedBox(height: 10.0),

                            // Course 2
                            userProf.generateTextField(
                                'course code', _course2Controller),
                            const SizedBox(height: 10.0),

                            // Course 3
                            userProf.generateTextField(
                                'course code', _course3Controller),
                            const SizedBox(height: 30),
